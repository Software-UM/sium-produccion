    ...
    <section class="content">
        <div class="row">
            ...
            <form role="form" method="POST" class="form-horizontal"
                  action="{{url("/modules/personal/add")}}" enctype="multipart/form-data">
                <div class="col-sm-12">
                    <div class="col-sm-6">
                                ...
                                <div class="form-group {{ $errors->has('apellidos') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="apellidos" name="apellidos"
                                               class="form-control input-sm" value="{{ old('apellidos') }}"/>
                                ...
                                <div class="form-group {{ $errors->has('fechaNacimiento') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8 input-group date"
                                        ...
                                        <input type="text" id="fechaNacimiento" name="fechaNacimiento"
                                               class="form-control input-sm" value="{{ old('fechaNacimiento') }}"/>
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="estados" name="estados" class="select2 form-control input-sm"
                                ...
                                <div class="form-group {{ $errors->has('cp') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" id="cp" name="cp" class="form-control input-sm col-xs-3"
                                               value="{{ old('cp') }}">
                                        @if ($errors->has('cp'))
                                            <p class="help-block">
